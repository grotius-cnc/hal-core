...
class Trajectory {
    ...
    static bool synchronize(const Vector<Block>& blocks, std::experimental::optional<double> t_min, double& t_sync, int& limiting_dof, Vector<Profile>& profiles, bool discrete_duration, double delta_time) {
