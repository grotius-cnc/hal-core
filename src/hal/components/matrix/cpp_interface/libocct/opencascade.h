...
public:
    ...
    void draw_gcode(int machine_id, DATA *ptr, int gcodevec_id);
    void delete_gcode(int gcodevec_id);
    ...
    //! Move machine joints.
    void Move_assembly_joints(DATA *ptr, std::vector<gp_Trsf> TrsfVec, std::vector<gp_Trsf> TrsfVecMachineOffset);

    void display_shape(Handle(AIS_Shape) shape);
    void redisplay_shape(Handle(AIS_Shape) shape);
    void select_shape(Handle(AIS_Shape) shape);
    void Redraw();
