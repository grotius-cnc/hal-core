...
scurve_pro_orig::scurve_pro_orig()
{

}

//! Inputs:
//! gain=curve power. [use gain=100]
//! am=acceleration a.
//! vo=velocity begin.
//! ve=velocity end.
...
scurve_pro_orig::SCURVE scurve_pro_orig::scurve_fwd(double gain, double am, double vo, double ve, double at_time){

    scurve_pro_orig::SCURVE r;
    gain=100;
...
//! sr=displacement result.
//! ar=acceleration result.
scurve_pro_orig::SCURVE scurve_pro_orig::scurve_bck(double gain, double am, double vo, double ve, double at_time){
...
//! sr=displacement result.
//! ar=acceleration result.
scurve_pro_orig::SCURVE scurve_pro_orig::motion(double s, double vo, double ve, double vs, double a, double at_time, double gain){
