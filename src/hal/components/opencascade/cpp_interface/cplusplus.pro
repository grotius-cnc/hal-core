...
# To start the app stand alone, deactivate line 6,7,8.
TEMPLATE = lib
DEFINES += NEXT_LIBRARY
TARGET = opencascade
# to start the app from a shared library, set the executable runscript in  project->run->executable.  /c-project/runtest
