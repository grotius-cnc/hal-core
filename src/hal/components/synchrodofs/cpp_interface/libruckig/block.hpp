...
class Block {
    ...
    inline static void add_interval(std::experimental::optional<Block::Interval>& interval, const Profile& left, const Profile& right) {
...
public:
    ...
    std::experimental::optional<Interval> a, b;
